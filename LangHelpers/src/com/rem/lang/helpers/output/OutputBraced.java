...
public class OutputBraced  extends Output {
	...
	public OutputBraced set(char subject){
		this.subject = new OutputExact(subject);
		return this;
	}
	public OutputBraced set(byte subject){
		this.subject = new OutputExact(subject);
		return this;
	}
	public OutputBraced set(short subject){
		this.subject = new OutputExact(subject);
		return this;
	}
	public OutputBraced set(boolean subject){
		this.subject = new OutputExact(subject);
		return this;
	}
	public OutputBraced set(String subject){
		this.subject = new OutputExact(subject);
		return this;
	}
	public OutputBraced set(long subject){
		this.subject = new OutputExact(subject);
		return this;
	}
	public OutputBraced set(double subject){
		this.subject = new OutputExact(subject);
		return this;
	}
	public OutputBraced set(float subject){
		this.subject = new OutputExact(subject);
		return this;
	}
	public OutputBraced set(int subject){
		this.subject = new OutputExact(subject);
		return this;
	}
