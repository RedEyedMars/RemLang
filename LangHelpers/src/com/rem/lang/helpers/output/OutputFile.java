...
public class OutputFile implements Outputable {
	...
	public void outputToFile(File rootDirectory) {
		OutputClassStructure.writeFile(new File(rootDirectory,this.fileClass.getPackageName().evaluate().replace(".", File.separator)), this.fileClass.getName().evaluate()+".java", this);
	}

	@Override
	public void output(Consumer<String> builder) {
		fileClass.addConstructors();
