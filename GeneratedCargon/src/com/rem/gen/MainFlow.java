...
public  class MainFlow extends GeneralFlowController{
	...
	public void setupGenerators() {
		...
		ExternalClassEntry.suppliment("EnumMap","java.util");
	...
	public void generate(final com.rem.gen.parser.Parser.Result.Pass data) {
		...
		if(root.get(com.rem.gen.parser.Token.Id._ignores)!=null) {
			for (final com.rem.gen.parser.Token element: root.getAllSafely(com.rem.gen.parser.Token.Id._ignores)) {
				for (final com.rem.gen.parser.Token atom: element.getAllSafely(com.rem.gen.parser.Token.Id._ignoreCharacter)) {
		...
		for (final com.rem.gen.parser.Token list: root.getAllSafely(com.rem.gen.parser.Token.Id._list)) {
			Parser._.list(list);
		}
		for (final com.rem.gen.parser.Token rule: root.getAllSafely(com.rem.gen.parser.Token.Id._rule)) {
