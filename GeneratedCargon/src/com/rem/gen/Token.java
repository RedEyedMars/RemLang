...
public class Token extends ExternalClassEntry{
	...
	public static class Parsed extends ExternalClassEntry{
		...
		public void __add_variable_0__(){
			addVariable(new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("List"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Token"),""),new ExternalStatement(new StringEntry("Parsed"),"")))))),"",new ExternalStatement(new StringEntry("children"),""),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("ArrayList"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Token"),""),new ExternalStatement(new StringEntry("Parsed"),"")))))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
		}
	...
	public static class Branch extends ExternalClassEntry{
		...
		public void __add_variable_4__(){
			addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("parentPosition"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))));
		}
		public void __add_variable_5__(){
			addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Parser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Pass"),""))),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("context"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))));
		}
		public void __add_method_0__(){
