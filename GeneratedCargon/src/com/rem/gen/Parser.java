...
public class Parser extends ExternalClassEntry{
	...
	public void list(final com.rem.gen.parser.Token input){
		...
		ExternalClassEntry.classMap.get("Parser").getSubClass("Context").addVariable(new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Parser"),""),new ExternalStatement(new StringEntry("NameList"),""))),"",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new VariableNameEntry((input.get("listName")).toString()),""),new ExternalStatement(new StringEntry("_additions"),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))));
		...
		for(final String listName:listNames){
			if(globalListNames.contains(listName)==false){
				...
				if(MainFlow.self.variableDeclarationNames.add(subListName)){
					ExternalClassEntry.classMap.get("Parser").getSubClass("Context").addVariable(new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Parser"),""),new ExternalStatement(new StringEntry("NameList"),""))),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((subListName).toString()),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))));
				}
	...
	public String define(final com.rem.gen.parser.Token input,final String previousParentRuleName,final String handleBracedTokenName,final Set<String> parentImportRuleNames){
		...
		if(input.get("import_parameter")!=null){
			...
			public void __add_method_3__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("setString"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("newValue"),"")),null)}),null,new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("value"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("value"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("newValue"),"")))))))));}});
	...
	public ExternalStatement.Body encloseRuleByMultiple(final com.rem.gen.parser.Token multiple,final String ruleName,final ExternalStatement.Body rule){
		...
		final ExternalStatement.Body aftBody = handleListAdditionAftBodies.get(ruleName);
