...
new Entry(){public void get(StringBuilder builder){}},
	...
	public void findRuleHeirachy(final com.rem.gen.parser.Token ruleToken){
		if(ruleToken.get("ruleName")!=null){
			...
			for (final com.rem.gen.parser.Token definition: ruleToken.getAllSafely("definition")){
	...
	public void findRuleHeirachy(final String ruleName,final com.rem.gen.parser.Token definition,final com.rem.gen.parser.Token parentRule,final Set<String> subRuleSet){
		...
		for (final com.rem.gen.parser.Token chain: definition.getAllSafely("chain")){
			for (final com.rem.gen.parser.Token element: chain.getAllSafely("element")){
				if(hasFoundStopToken==false){
					for (final com.rem.gen.parser.Token atom: element.getAll()){
						if (atom.getName().equals("multiple")){
							for (final com.rem.gen.parser.Token quark: atom.getAllSafely("definition")){
		...
		for (final com.rem.gen.parser.Token choice: definition.getAllSafely("choice")){
			for (final com.rem.gen.parser.Token element: choice.getAllSafely("definition")){
	...
	public void list(final com.rem.gen.parser.Token input){
		...
		ExternalClassEntry.classMap.get("Parser").getSubClass("Context").getMethod("*").appendToBody(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((input.get("listName")).toString()),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new VariableNameEntry((input.get("listName")).toString()),""),new ExternalStatement(new StringEntry("_root"),""))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("push"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))))));
		MainFlow.self.listNames.add((input.get("listName")).toString());
		for (final com.rem.gen.parser.Token element: input.getAllSafely("SYNTAX")){
		...
		for (final com.rem.gen.parser.Token element: input.getAllSafely("quote")){
	...
	public void getRuleBody(final ExternalStatement.Body completeBody,final String ruleName,final Map<String,Set<Integer>> excludeIndicesMap){
		...
		if(declaredBraceRules.containsKey(ruleName)){
			final String currentPositionValue = "_position_"+(ruleName).toString()+"_brace";
			withinBraces.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement(null,null,"==",Arrays.asList(new String[]{"","==","&&","=="}),new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("brace_"),""),new ExternalStatement(new VariableNameEntry((braceIds.get(declaredBraceRules.get(ruleName))).toString()),""))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("_position_"),""),new ExternalStatement(new VariableNameEntry((ruleName).toString()),""),new ExternalStatement(new StringEntry("_brace"),""))))))),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("+=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((declaredBraceCloseLengths.get(ruleName)).toString()),"")))))),new ExternalStatement.Conditional("else","(",null,")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),"")))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Parser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Fail"),""),new ExternalStatement(new StringEntry("EOB"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("\""),new StringEntry("\""),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((ruleName).toString()),"")))),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_lineNumberRanges"),"")))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("brace_"),""),new ExternalStatement(new VariableNameEntry((braceIds.get(declaredBraceRules.get(ruleName))).toString()),""))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("_position_"),""),new ExternalStatement(new VariableNameEntry((ruleName).toString()),""),new ExternalStatement(new StringEntry("_brace"),""))))))),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((declaredBraceCloseLengths.get(ruleName)).toString()),""))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_succeedOnEnd"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("false"),"")))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_inputLength"),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentLengthValue).toString()),"")))),new ExternalStatement.Conditional("while","(",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(MainFlow.self.globalIgnoresHeader),"")),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("++_position"),"")))))));
		}
...
new Entry(){public void get(StringBuilder builder){}},
	...
	new ExternalStatement.TypeName(new ExternalStatement(new VariableNameEntry((previousContextClassNameValue).toString()),"")),
	Arrays.asList(new Entry[]{}),
	null);__add_variable_0__();;__add_variable_1__();;__add_method_0__();;__add_method_1__();;__add_method_2__();;__add_method_3__();}
	...
	public String define(final com.rem.gen.parser.Token input,final String previousParentRuleName,final String handleBracedTokenName,final Set<String> parentImportRuleNames){
		...
		if(input.get("ruleName")!=null){
			...
			public void __add_method_0__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),null,new ExternalStatement(new StringEntry("getValue"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("value"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("super"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getValue"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))))),new ExternalStatement.Conditional("else","(",null,")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("value"),""))))))));}
			public void __add_method_1__(){
		...
		if(input.get("ignores_character")!=null){
			...
			for (final com.rem.gen.parser.Token character: input.getAllSafely("ignores_character")){
		...
		if(input.get("import_parameter")!=null){
			...
			for (final com.rem.gen.parser.Token parameter: input.getAllSafely("import_parameter")){
			...
			for (final com.rem.gen.parser.Token definition: input.getAllSafely("definition")){
	...
	public void define(final com.rem.gen.parser.Token definition,final String ruleName,final String parentRuleName,final String handleBracedTokenName,final Set<String> importRuleNames,final ExternalStatement.Body importFileNameBody,final List<ExternalStatement.Body> inputRule){
		...
		if(silentRules.contains(ruleName)==false||handleBracedTokenName!=null){
			...
			inputRule.get(inputRule.size()-1).add(new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentTokenValue).toString()),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("addAll"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentTokenValue).toString()),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("setValue"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getValue"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentTokenValue).toString()),""))))));
		}
		...
		for (final com.rem.gen.parser.Token query: element.getAll()){
			...
			if (query.getName().equals("quoteToken")){
				...
				if(createdSyntaxTokens.containsKey(quote)==false){
					...
					setIsStatic(true);;__add_variable_0__();;__add_method_0__();;__add_method_1__();;__add_method_2__();}
			public void __add_variable_0__(){
				addVariable(new ExternalVariableEntry(false,true,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Tokens"),""),new ExternalStatement(new StringEntry("Syntax"),""),new ExternalStatement(new VariableNameEntry((quoteName).toString()),""))),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("__SYNTAX__"),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Tokens"),""),new ExternalStatement(new StringEntry("Syntax"),""),new ExternalStatement(new VariableNameEntry((quoteName).toString()),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("\""),new StringEntry("\""),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("SYNTAX"),"")))))))));}
			public void __add_method_0__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new StringEntry("void")),"",new Entry(){public void get(StringBuilder builder){builder.append("set_SYNTAX");}},Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Tokens"),""),new ExternalStatement(new StringEntry("Syntax"),""),new ExternalStatement(new VariableNameEntry((quoteName).toString()),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("new_SYNTAX");}},null)}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("__SYNTAX__ = ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("new_SYNTAX"),"")))));}
			public void __add_method_1__(){
			...
			public void __add_method_2__(){
				...
				if(element.get("newName")!=null){
					...
					if(createdSyntaxNameTokens.get(quote).add(newTokenName)){
						ExternalClassEntry.classMap.get("Tokens").getSubClass("Syntax").getSubClass(""+quoteName.toString()+"").addVariable(new ExternalVariableEntry(false,true,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Token"),""),new ExternalStatement(new StringEntry("Parsed"),""))),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((newTokenName).toString()),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Tokens"),""),new ExternalStatement(new StringEntry("Syntax"),""),new ExternalStatement(new VariableNameEntry((quoteName).toString()),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("\""),new StringEntry("\""),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((newTokenName).toString()),"")))))))));
					}
				}
				else{
					newTokenName="__SYNTAX__";
				}
				rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Tokens"),""),new ExternalStatement(new StringEntry("Syntax"),""),new ExternalStatement(new VariableNameEntry((quoteName).toString()),""),new ExternalStatement(new VariableNameEntry((newTokenName).toString()),"")))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((quoteLengthValue).toString()),""))))),new ExternalStatement.Conditional("while","(",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(MainFlow.self.ruleIgnoresHeaders.get(ruleName)),"")),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("++_position"),""))))))),new ExternalStatement.Conditional("else if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),""))),")",new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement(">=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_furthestPosition"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Parser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Fail"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_lineNumberRanges"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_input"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("\""),new StringEntry("\""),"",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("unexpected plain "),""),new ExternalStatement(new VariableNameEntry((quoteValue).toString()),"")))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_furthestPosition"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),""))))))))));
			...
			if (query.getName().equals("regexToken")){
				...
				for (final com.rem.gen.parser.Token regexElement: regex.getAllSafely("regex_element")){
			...
			public void __add_method_2__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),null,new ExternalStatement(new StringEntry("getName"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("\""),new StringEntry("\""),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((element.get("newName")).toString()),""))))))));}});
					...
					if(element.get("listName")!=null){
						rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentPositionValue).toString()),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Tokens"),""),new ExternalStatement(new StringEntry("Plain"),""),new ExternalStatement(new VariableNameEntry((newTokenName).toString()),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_input"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("substring"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentPositionValue).toString()),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")))))))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((element.get("listName")).toString()),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_input"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("substring"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentPositionValue).toString()),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),""))))))))))),new ExternalStatement.Conditional("while","(",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(MainFlow.self.ruleIgnoresHeaders.get(ruleName)),"")),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("++_position"),"")))))))));
						if(listNamesInRule.containsKey(parentRuleName)==false){
							listNamesInRule.put(parentRuleName,new HashSet<String>());
						}
						listNamesInRule.get(parentRuleName).add((element.get("listName")).toString());
			...
			if (query.getName().equals("ruleToken")){
				if(MainFlow.self.listNames.contains((query).toString())){
					...
					if(element.get("newName")!=null&&element.get("listName")==null){
						rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("_token_"),""),new ExternalStatement(new VariableNameEntry((subRuleName).toString()),""))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("_position_"),""),new ExternalStatement(new VariableNameEntry((subRuleName).toString()),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")))))))))));
					...
					if(element.get("listName")!=null){
						...
						rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(new StringEntry("_value"),""),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getLastValue"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))),new ExternalStatement.Conditional("if","(",new ExternalStatement("!=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_value"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((element.get("listName")).toString()),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_value"),""))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("Tokens"),""),new ExternalStatement(new StringEntry("Name"),""),new ExternalStatement(new VariableNameEntry((listTokenName).toString()),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_value"),""))))))))))))));
						if(listNamesInRule.containsKey(parentRuleName)==false){
							listNamesInRule.put(parentRuleName,new HashSet<String>());
						}
						listNamesInRule.get(parentRuleName).add((element.get("listName")).toString());
	...
	public String addRegexElementToRule(final com.rem.gen.parser.Token element,final ExternalStatement.Body rule,final String positionName){
		...
		if(element.get("option")!=null){
				...
				for (final com.rem.gen.parser.Token atom: optionToken.getAll()){
					...
					if (atom.getName().equals("regex_special")){
						for (final com.rem.gen.parser.Token quark: atom.getAll()){
							...
							if (quark.getName().equals("escaped")){
			...
			if(element.get("regex_special")!=null){
				final ExternalStatement option = new ExternalStatement();
				option.set("||");
				for (final com.rem.gen.parser.Token quark: element.get("regex_special").getAll()){
					if (quark.getName().equals("number")){
						final Character ch = "0".charAt(0);
						final Integer end = "9".charAt(0)-ch;
						for(Integer i = 0;i<=end;i++){
			...
			if(element.get("character")!=null){
				...
				for (final com.rem.gen.parser.Token regexElement: regexToken.getAllSafely("regex_element")){
	...
	public ExternalStatement.Body getRegexForPreparer(final com.rem.gen.parser.Token element,final String ruleName,final ExternalClassEntry preparerClass,final Integer preparerState){
		...
		if(element.get("group")!=null){
			...
			public void __add_method_0__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("boolean"),"")),null,new ExternalStatement(new StringEntry("can"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("int"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")),null),new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("char"),"")),"",new ExternalStatement(new StringEntry("nextChar"),""),null)}),null,new ExternalStatement.Body()));}});
			preparerClass.addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(preparerClass.getName()),""),new ExternalStatement(new VariableNameEntry((groupClass).toString()),""))),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((groupMember).toString()),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(preparerClass.getName()),""),new ExternalStatement(new VariableNameEntry((groupClass).toString()),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
			...
			final ExternalStatement.Body switchBody = new ExternalStatement.Body();
			for (final com.rem.gen.parser.Token regexElement: element.get("group").get("regex").getAllSafely("regex_element")){
	...
	public static class NameList extends ExternalClassEntry{
		...
		public void __add_method_9__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("NameList"),"")),null,new ExternalStatement(new StringEntry("push"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("int"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")),null),new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("int"),"")),"",new ExternalStatement(new StringEntry("pass"),""),null)}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("NameList"),"")),"",new ExternalStatement(new StringEntry("result"),""),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),"")))),new ExternalStatement.Conditional("if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("pass"),"")),new ExternalStatement(".",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Parser"),"")),new ExternalStatement(new StringEntry("SECOND_PASS"),""))),")",new ExternalStatement.Body(new ExternalStatement.Conditional("synchronized","(",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")))))))))))),new ExternalStatement.Conditional("if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("NameList"),"")))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("this"),""))))))),new ExternalStatement.Conditional("if","(",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("pass"),"")),new ExternalStatement(".",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Parser"),"")),new ExternalStatement(new StringEntry("FIRST_PASS"),""))),")",new ExternalStatement.Body(new ExternalStatement.Conditional("synchronized","(",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("put"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),""))))))))))))),new ExternalStatement.Conditional("else","(",null,")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("clear"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))))),new ExternalStatement.Conditional("synchronized","(",new ExternalStatement(".",new ExternalStatement(new StringEntry("this"),"")),")",new ExternalStatement.Body(new ExternalStatement.Conditional("synchronized","(",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),")",new ExternalStatement.Body(new ExternalStatement.Conditional("for","(",new ExternalStatement(":",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(new StringEntry("newEntry"),""),null),new ExternalStatement(".",new ExternalStatement(new StringEntry("this"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("safe_add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("newEntry"),""))))))))))))),new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),""))))));
		}
		public void __add_method_10__(){
		...
		public void __add_method_12__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("boolean"),"")),null,new ExternalStatement(new StringEntry("add"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(new StringEntry("addition"),""),null)}),null,new ExternalStatement.Body(new ExternalStatement.Conditional("synchronized","(",new ExternalStatement(".",new ExternalStatement(new StringEntry("this"),"")),")",new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("super"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("addition"),"")))))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("additions"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Addition"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("addition_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("addition"),"")))))))))),new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("true"),""))))),new ExternalStatement.Conditional("else","(",null,")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("false"),""))))))))));
		}
		public void __add_method_13__(){
		...
		public void __add_method_16__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("reject"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("int"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")),null)}),null,new ExternalStatement.Body(new ExternalStatement.Conditional("synchronized","(",new ExternalStatement(".",new ExternalStatement(new StringEntry("this"),"")),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("addition_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("int"),"")),"",new ExternalStatement(new StringEntry("i"),""),new ExternalStatement("-",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("additions"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("size"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(new StringEntry("1"),""))))),new ExternalStatement.Conditional("while","(",new ExternalStatement(">=",new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("0 "),""))),")",new ExternalStatement.Body(new ExternalStatement.Conditional("if","(",new ExternalStatement(">=",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("additions"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),""))))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getPosition"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(new StringEntry("addition_position"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new StringEntry("remove"),"")),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("additions"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("remove"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),""))))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getEntry"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))))))),new ExternalStatement.Conditional("else","(",null,")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("break"),""))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("--i"),""))))))))));
		}
		public void __add_method_17__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("extend"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement.Conditional("synchronized","(",new ExternalStatement(".",new ExternalStatement(new StringEntry("parent"),"")),")",new ExternalStatement.Body(new ExternalStatement.Conditional("for","(",new ExternalStatement(":",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(new StringEntry("entry"),""),null),new ExternalStatement(".",new ExternalStatement(new StringEntry("parent"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new StringEntry("safe_add"),"")),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("entry"),"")))))))))))));
		}
		public void __add_method_18__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("keep"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement.Conditional("synchronized","(",new ExternalStatement(".",new ExternalStatement(new StringEntry("this"),"")),")",new ExternalStatement.Body(new ExternalStatement.Conditional("synchronized","(",new ExternalStatement(".",new ExternalStatement(new StringEntry("parent"),"")),")",new ExternalStatement.Body(new ExternalStatement.Conditional("for","(",new ExternalStatement(":",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Addition"),""))),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("addition"),"")),null),new ExternalStatement(".",new ExternalStatement(new StringEntry("additions"),""))),")",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("parent"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("safe_add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("addition"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getEntry"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("additions"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("clear"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))))))));
		}
		public void __add_sub_class_0__(){
