...
public class ExternalParser extends ExternalClassEntry{
	protected ExternalStatement.Body readInputBody = new ExternalStatement.Body();
	...
	public static final ExternalParser _ = new ExternalParser();
	public ExternalStatement.Body getReadInputBody(){
		return readInputBody;
	}
	...
	public void output(){
		if(ROOT_NAME==null){
			...
			ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").getMethod("parse").appendToBody(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("parse_"),""),new ExternalStatement(new VariableNameEntry((ROOT_NAME).toString()),""))),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))));
			ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").getMethod("parse").appendToBody(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement(null,null,"==",Arrays.asList(new String[]{"","==","&&","=="}),new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_inputLength"),""))),new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement(".",new ExternalStatement(new StringEntry("_succeedOnEnd"),"")),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Pass"),""))),"",new ExternalStatement(new StringEntry("pass"),""),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Pass"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_lineNumberRanges"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_input"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_root"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("pass"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("setup"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("pass"),"")))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("setFileName"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_fileName"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")))))))),new ExternalStatement.Conditional("else if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("!=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),""))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Fail"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_lineNumberRanges"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_input"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_fileName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"tail of file could not be parsed\""),""))))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("setFileName"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_fileName"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")))))),new ExternalStatement.Conditional("else if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("setFileName"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_fileName"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),""))))))));
			ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").getMethod("parse").appendToBody(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("long"),"")),"",new ExternalStatement(new StringEntry("parseTime"),""),new ExternalStatement("-",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("System"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("currentTimeMillis"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(new StringEntry("startParseTime"),"")))))));
			ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").getMethod("parse").appendToBody(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("setParseTime"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")))))))));
			ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").getMethod("parse").appendToBody(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),"")))));
			ExternalClassEntry.classMap.get("ExternalParser").getMethod("parseFile").appendToBody(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_pass"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FIRST_PASS"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Context"),""))),"",new ExternalStatement(new StringEntry("context"),""),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Context"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("contexts"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("put"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("context"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("context"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("parse"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FIRST_PASS"),""))))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("contexts"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),""))))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("parse"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SECOND_PASS"),"")))))))))));
		}
	}
	public void outputBraces(){
		...
		readInputBody.add(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_inputBuffer"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("append"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("(char)_readInput"),""))))))),new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_readInput"),"")),new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("'"),""),new ExternalStatement(new StringEntry("\\n"),""),new ExternalStatement(new StringEntry("'"),"")))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_lineNumberRanges"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),""))))))))),new ExternalStatement.Conditional("if",new ExternalStatement(".",new ExternalStatement(new StringEntry("escaping"),"")),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("escaping"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("false"),"")))))),new ExternalStatement.Conditional("else if",new ExternalStatement(null,null,"==",Arrays.asList(new String[]{"","&&","=="}),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((notEscaping).toString()),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_readInput"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("'"),new StringEntry("'"),"",new ExternalStatement(new StringEntry("\\"),"")))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("escaping"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("true"),"")))))),new ExternalStatement.Conditional("else if",new ExternalStatement(null,null,"==",Arrays.asList(new String[]{"","&&","=="}),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((notQuoting).toString()),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_readInput"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("'"),new StringEntry("'"),"",new ExternalStatement(new StringEntry("\""),"")))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("quoting"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("true"),"")))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("brace_open_0"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("push"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),""))))))))),new ExternalStatement.Conditional("else if",new ExternalStatement(null,null,"==",Arrays.asList(new String[]{"","&&","=="}),new ExternalStatement(".",new ExternalStatement(new StringEntry("quoting"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_readInput"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("'"),new StringEntry("'"),"",new ExternalStatement(new StringEntry("\""),"")))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("quoting"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("false"),"")))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("brace_0"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("put"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("brace_open_0"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("pop"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),""))))))))),new ExternalStatement.Conditional("else if",new ExternalStatement("&&",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((notQuoting).toString()),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((notEscaping).toString()),""))),new ExternalStatement.Body()),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1"),"")))))));
		Integer i = maxOpen;
		while(i>0 ){
			if(declaredBraceCloseValues.containsKey(i)){
				...
				for(final String key:closeMap.keySet()){
					...
					readBracesBody.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(closeHeader),""))),new ExternalStatement.Body())));
					if(key.length()==1 ){
			...
			if(declaredBraceOpenValues.containsKey(i)){
				...
				for(final String key:openMap.keySet()){
					...
					readBracesBody.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(openHeader),""))),new ExternalStatement.Body())));
					if(key.length()==1 ){
		...
		while(i>1 ){
			...
			ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").addVariable(new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("int"),"")),"",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("_readInput_"),""),new ExternalStatement(new VariableNameEntry((index).toString()),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("0"),""))));
		...
		if(max>0 ){
			ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").addVariable(new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("int"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("_readInput_1"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("0"),""))));
	...
	public void setupCompile(){
		...
		ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Map"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),""))))),"",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("brace_"),""),new ExternalStatement(new VariableNameEntry((braceId).toString()),""))),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("HashMap"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),""))))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
		ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").getMethod("parse").prependToBody(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Stack"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),""))))),"",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("brace_open_"),""),new ExternalStatement(new VariableNameEntry((braceId).toString()),""))),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Stack"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),""))))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))));
	}
	public void list(final Token input){
		final String listName = (input.get("listName")).toString();
		ExternalClassEntry.classMap.get("ExternalParser").addVariable(new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Root"),""))),"",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new VariableNameEntry((listName).toString()),""),new ExternalStatement(new StringEntry("_root"),""))),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Root"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
		ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""))),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((input.get("listName")).toString()),"")),new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new VariableNameEntry((input.get("listName")).toString()),""),new ExternalStatement(new StringEntry("_root"),"")))));
		ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""))),"",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new VariableNameEntry((input.get("listName")).toString()),""),new ExternalStatement(new StringEntry("_additions"),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))));
		ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Map"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),"")))))),"",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new VariableNameEntry((input.get("listName")).toString()),""),new ExternalStatement(new StringEntry("_first_passes"),""))),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("HashMap"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),"")))))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
		...
		for (Token element: input.getAllSafely("quote")){
			ExternalClassEntry.classMap.get("ExternalParser").getMethod("parseFile").appendToBody(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new VariableNameEntry((listName).toString()),""),new ExternalStatement(new StringEntry("_root"),""))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("\""),new StringEntry("\""),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((element).toString()),"")))))))))));
		}
	}
		...
		for(final String listName:listNames){
			if(globalListNames.contains(listName)==false){
				...
				if(MainFlow.self.variableDeclarationNames.add(subListName)){
					ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""))),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((subListName).toString()),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))));
				}
				...
				if(hasSecondPass){
					listDeclarations.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_pass"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SECOND_PASS"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((listName).toString()),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Child"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((listName).toString()),"")))))))))));
				}
				else{
					listDeclarations.add(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((listName).toString()),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Child"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((listName).toString()),"")))))))));
				}
			}
		}
	...
	public void getRuleBody(final ExternalStatement.Body completeBody,final String ruleName,final Map<String,Set<Integer>> excludeIndicesMap){
		...
		currentOption.add(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentRuleTokenValue).toString()),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))))));
		if(declaredBraceRules.containsKey(ruleName)){
			...
			if(declaredBracePasses.containsKey(ruleName)){
				if(declaredBracePasses.get(ruleName)==1 ){
					withinBraces.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_pass"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FIRST_PASS"),""))),new ExternalStatement.Body())));
		...
		if(handleListAdditions.containsKey(ruleName)){
			...
			if(listNamesInRule.containsKey(forRuleName)){
				for(final String listName:listNamesInRule.get(forRuleName)){
					...
					currentOption.add(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new VariableNameEntry((listName).toString()),""),new ExternalStatement(new StringEntry("_additions"),""))),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Child"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((listName).toString()),"")))))))));
		...
		for(Integer i = 0;i<rule.size();i++){
			...
			if(handleRecursionProtection.contains(ruleName)){
				...
				ExternalClassEntry.classMap.get("ExternalParser").getSubClass("Context").addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Set"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),""))))),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((recursionProtectionVariable).toString()),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("HashSet"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),""))))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
				if(previousOption!=null){
					previousOption.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement(null,null,"==",Arrays.asList(new String[]{"","==","&&","=="}),new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((recursionProtectionVariable).toString()),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("contains"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")))))),new ExternalStatement(".",new ExternalStatement(new StringEntry("false"),""))),new ExternalStatement.Body())));
				}
				else{
					final ExternalStatement.Body innerBody = new ExternalStatement.Body();
					currentOption.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement(null,null,"==",Arrays.asList(new String[]{"","==","&&","=="}),new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((recursionProtectionVariable).toString()),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("contains"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")))))),new ExternalStatement(".",new ExternalStatement(new StringEntry("false"),""))),new ExternalStatement.Body()),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),""))))))));
					currentOption=innerBody;
				}
				currentOption.add(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((recursionProtectionVariable).toString()),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")))))))));
			}
			else{
				recursionProtectionVariable=null;
				if(previousOption!=null){
					previousOption.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),""))),new ExternalStatement.Body())));
				}
			}
			if(previousOption!=null){
				if(handleListAdditions.containsKey(ruleName)){
			...
			if(handleRecursionProtection.contains(ruleName)){
				currentOption.add(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((recursionProtectionVariable).toString()),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("remove"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentRulePositionValue).toString()),"")))))))));
			}
			currentOption=new ExternalStatement.Body();
		}
		if(declaredBraceRules.containsKey(ruleName)){
			final String currentPositionValue = "_position_"+(ruleName).toString()+"_brace";
			withinBraces.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement(null,null,"==",Arrays.asList(new String[]{"","==","&&","=="}),new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("brace_"),""),new ExternalStatement(new VariableNameEntry((braceIds.get(declaredBraceRules.get(ruleName))).toString()),""))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("_position_"),""),new ExternalStatement(new VariableNameEntry((ruleName).toString()),""),new ExternalStatement(new StringEntry("_brace"),""))))))),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("+=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((declaredBraceCloseLengths.get(ruleName)).toString()),"")))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),"")))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result_acceptor"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Fail"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_lineNumberRanges"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_input"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_fileName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"Did not reach end of braces\""),""))))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("brace_"),""),new ExternalStatement(new VariableNameEntry((braceIds.get(declaredBraceRules.get(ruleName))).toString()),""))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new ExternalStatement(new StringEntry("_position_"),""),new ExternalStatement(new VariableNameEntry((ruleName).toString()),""),new ExternalStatement(new StringEntry("_brace"),""))))))),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((declaredBraceCloseLengths.get(ruleName)).toString()),""))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_succeedOnEnd"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("false"),"")))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_inputLength"),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((currentLengthValue).toString()),"")))),new ExternalStatement.Conditional("while",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(MainFlow.self.ignoresHeaderStatement),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("++_position"),"")))))));
		}
		if(handleListAdditions.containsKey(ruleName)){
			final String forRuleName = handleListAdditions.get(ruleName);
			if(listNamesInRule.containsKey(forRuleName)){
				...
				previousOption.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),""))),new ExternalStatement.Body())));
				previousOption.add(new ExternalStatement.Body(new ExternalStatement.Conditional("else if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),new ExternalStatement.Body())));
				if(declaredBraceRules.containsKey(ruleName)){
	...
	public String define(final Token input,final String previousParentRuleName){
		...
		if(input.get("ruleName")!=null){
			...
			ExternalClassEntry.classMap.get("ExternalParserTokens").getSubClass("Rule").addSubClass(new ExternalClassEntry(){public void __INIT__(){super.__SETUP__(
				new ExternalStatement("."),
			new Entry(){public void get(StringBuilder builder){}},
				new VariableNameEntry((ruleClassName).toString()),
				"class ",
				new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),
		...
		for (Token definition: input.getAllSafely("definition")){
			define(definition,ruleName,parentRuleName,rule);
		}
		return ruleName;
	}
	public void define(final Token definition,final String ruleName,final String parentRuleName,final List<ExternalStatement.Body> inputRule){
		...
		if(silentRules.contains(ruleName)==false){
			rule.add(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserTokens"),""),new ExternalStatement(new StringEntry("Rule"),""),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(ruleAsClass),"")))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))));
		}
		else{
			rule.add(new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"$ANON\""),""))))))))));
		}
		final ExternalStatement.Body foreBody = ruleForeBodies.get(ruleName);
		for (Token chain: definition.getAllSafely("chain")){
			for (Token element: chain.getAllSafely("element")){
	...
	public void parseElement(final Token element,final String ruleName,final String parentRuleName,final ExternalStatement.Body rule,final Integer choiceIndex,final Boolean isFirst){
		for (Token query: element.getAll()){
			if (query.getName().equals("multiple")){
				...
				for (Token option: query.get("option").getAll()){
					...
					if (option.getName().equals("MANY")){
						...
						rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("while",new ExternalStatement("<",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_inputLength"),""))),new ExternalStatement.Body())));
						...
						if(aftBody!=null){
							...
							whileRuleBody.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),""))),new ExternalStatement.Body())));
							rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement(null,null,"==",Arrays.asList(new String[]{"","==","&&","=="}),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((stateName).toString()),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),new ExternalStatement.Body())));
						}
						else{
			...
			if (query.getName().equals("quoteToken")){
				...
				for(Integer i = 0;i<quote.length();i++){
					...
					final String charArrayValue = "_inputArray[_position+"+ip+"]";
					subrule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("!=",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((charArrayValue).toString()),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((ch).toString()),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),""))))))));
					ip+=1;
				}
				...
				if(element.get("newName")!=null){
					...
					if(createdPlainTokens.add(newTokenName)){
						ExternalClassEntry.classMap.get("Tokens").getSubClass("Plain").addSubClass(new ExternalClassEntry(){public void __INIT__(){super.__SETUP__(
							new ExternalStatement("."),
						new Entry(){public void get(StringBuilder builder){}},
							new VariableNameEntry((newTokenName).toString()),
							"class ",
			...
			public void __add_method_2__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),null,new ExternalStatement(new StringEntry("getName"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("\""),new StringEntry("\""),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((element.get("newName")).toString()),""))))))));}});
					...
					plainTokenIndex+=1;
					ExternalClassEntry.classMap.get("ExternalParserTokens").getSubClass("Plain").getSubClass("newTokenName.toString()").addVariable(new ExternalVariableEntry(false,true,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((quoteName).toString()),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserTokens"),""),new ExternalStatement(new StringEntry("Plain"),""),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(newTokenName),"")))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("\""),new StringEntry("\""),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((quote).toString()),"")))))))));
					rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("_token"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserTokens"),""),new ExternalStatement(new StringEntry("Plain"),""),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(newTokenName),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(quoteName),""))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((quoteLength).toString()),""))))),new ExternalStatement.Conditional("while",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(MainFlow.self.ignoresHeaderStatement),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("++_position"),"")))))))));
				}
				else{
					rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((quoteLength).toString()),""))))),new ExternalStatement.Conditional("while",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(MainFlow.self.ignoresHeaderStatement),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("++_position"),"")))))))));
				}
				rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("else if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),""))),new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement(">=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_furthestPosition"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_result"),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Fail"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("FAILED"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_lineNumberRanges"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_input"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_fileName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement("+",new ExternalStatement(new StringEntry("\"unexpected plain \""),""),new ExternalStatement(new StringEntry("'"),new StringEntry("'"),"",new ExternalStatement(new StringEntry("\""),"")),new ExternalStatement(new VariableNameEntry((quoteValue).toString()),""),new ExternalStatement(new StringEntry("'"),new StringEntry("'"),"",new ExternalStatement(new StringEntry("\""),"")))))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_furthestPosition"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("_position"),""))))))))));
			}
			if (query.getName().equals("regexToken")){
				final Token regex = element.get("regexToken").get("regex");
				...
				for (Token regexElement: regex.getAllSafely("regex_element")){
				...
				if(element.get("newName")!=null){
					...
					if(createdPlainTokens.add(newTokenName)){
						ExternalClassEntry.classMap.get("ExternalParserTokens").getSubClass("Plain").addSubClass(new ExternalClassEntry(){public void __INIT__(){super.__SETUP__(
							new ExternalStatement("."),
						new Entry(){public void get(StringBuilder builder){}},
							new VariableNameEntry((newTokenName).toString()),
							"class ",
			...
			if (query.getName().equals("ruleToken")){
				if(listNames.contains((query).toString())){
					...
					if(createdNameTokens.add(newTokenClassName)){
						ExternalClassEntry.classMap.get("ExternalParserTokens").getSubClass("Name").addSubClass(new ExternalClassEntry(){public void __INIT__(){super.__SETUP__(
							new ExternalStatement("."),
						new Entry(){public void get(StringBuilder builder){}},
							new VariableNameEntry((newTokenClassName).toString()),
							"class ",
							new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),
							Arrays.asList(new Entry[]{}),
							null);
			...
			public void __add_method_1__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("setValue"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("newValue"),"")),null)}),null,new ExternalStatement.Body()));}
			public void __add_method_2__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),null,new ExternalStatement(new StringEntry("getName"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("\""),new StringEntry("\""),"",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry((newTokenName).toString()),""))))))));}});
					}
					...
					if(listFirstPassRules.containsKey((listName).toString())){
						...
						rule.add(new ExternalStatement.Body(new ExternalStatement.Conditional("else if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_pass"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SECOND_PASS"),""))),new ExternalStatement.Body())));
					}
					else{
						listRuleBody=rule;
					}
	...
	public String addRegexElementToRule(final Token element,final ExternalStatement.Body rule,final String positionName){
		...
		if(element.get("option")!=null){
			...
			if(element.get("option").get("negate")==null){
				option.set("||");
				final Token optionToken = element.get("option");
				for (Token atom: optionToken.getAll()){
					...
					if (atom.getName().equals("regex_special")){
						for (Token quark: atom.getAll()){
							if (quark.getName().equals("REGEX_NUMBER")){
							...
							if (quark.getName().equals("REGEX_WHITESPACE")){
							...
							if (quark.getName().equals("REGEX_QUOTE")){
								option.add(new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_inputArray[_position]"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("'"),new StringEntry("'"),"",new ExternalStatement(new StringEntry("\""),"")))));
								regexValue.append("\\\"");
							}
							if (quark.getName().equals("REGEX_DOT")){
								option.add(new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("_inputArray[_position]"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("'.'"),""))));
								regexValue.append("\\.");
							}
						}
				...
				for (Token atom: optionToken.getAll()){
					...
					if (atom.getName().equals("regex_special")){
						for (Token quark: atom.getAll()){
							...
							if (quark.getName().equals("REGEX_APOS")){
								option.add(new ExternalStatement("!=",new ExternalStatement(".",new ExternalStatement(new StringEntry("_inputArray[_position]"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("'"),new StringEntry("'"),"",new ExternalStatement(new StringEntry("'"),"")))));
								regexValue.append("\\\'");
							}
							if (quark.getName().equals("REGEX_DOT")){
			...
			if(element.get("regex_special")!=null){
				final ExternalStatement option = new ExternalStatement();
				option.set("||");
				for (Token quark: element.get("regex_special").getAll()){
					if (quark.getName().equals("REGEX_NUMBER")){
						final Character ch = "0".charAt(0);
						final Integer end = "9".charAt(0)-ch;
						for(Integer i = 0;i<=end;i++){
			...
			if(element.get("character")!=null){
				...
				final Token regexToken = element.get("group").get("regex");
				...
				for (Token regexElement: regexToken.getAllSafely("regex_element")){
	...
	public void __add_variable_5__(){
		addVariable(new ExternalVariableEntry(false,true,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Map"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Context"),"")))))),"",new ExternalStatement(new StringEntry("contexts"),""),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("HashMap"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Context"),"")))))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
	}
	public void __add_method_0__(){
	...
	public void __add_method_5__(){
		addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new StringEntry("void")),"",new Entry(){public void get(StringBuilder builder){builder.append("setContexts");}},Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Map"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Context"),"")))))),"",new Entry(){public void get(StringBuilder builder){builder.append("newContexts");}},null)}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("contexts = ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("newContexts"),"")))));
	}
	public void __add_method_6__(){
		addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),null,new ExternalStatement(new StringEntry("parse"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(new StringEntry("fileName"),""),null)}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),"",new ExternalStatement(new StringEntry("firstResult"),""),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new StringEntry("parseFile"),"")),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("FIRST_PASS"),""))))))),new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("firstResult"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getState"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("System"),"")),new ExternalStatement(new StringEntry("out"),""),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("println"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"First-Pass Successful\""),"")))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),"",new ExternalStatement(new StringEntry("secondResult"),""),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new StringEntry("parseFile"),"")),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("SECOND_PASS"),""))))))),new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("secondResult"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getState"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(new StringEntry("SUCCESS"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("System"),"")),new ExternalStatement(new StringEntry("out"),""),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("println"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"Second-Pass Successful\""),"")))))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("System"),"")),new ExternalStatement(new StringEntry("out"),""),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("println"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"Second-Pass Failed\""),"")))))))))),new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("secondResult"),""))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("System"),"")),new ExternalStatement(new StringEntry("out"),""),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("println"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"First-Pass Failed\""),"")))))))),new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("firstResult"),""))))))));
	}
	public void __add_method_7__(){
		addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),null,new ExternalStatement(new StringEntry("parseFile"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),null),new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("int"),"")),"",new ExternalStatement(new StringEntry("_pass"),""),null)}),null,new ExternalStatement.Body()));
	}
	...
	public void __INIT__(){
		...
		new Entry(){public void get(StringBuilder builder){}},
			new VariableNameEntry(("ExternalParser").toString()),
			"class ",
			null,
			Arrays.asList(new Entry[]{}),
			null);
	...
	public static class Context extends ExternalClassEntry{
		...
		public void __add_variable_9__(){
			addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),"",new ExternalStatement(new StringEntry("_result"),""),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))));
		}
		public void __add_variable_10__(){
			addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Acceptor"),""))),"",new ExternalStatement(new StringEntry("_result_acceptor"),""),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Acceptor"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
		}
		...
		public void __add_variable_14__(){
			addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),"",new ExternalStatement(new StringEntry("_root"),""),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"$ROOT\""),""))))))));
		}
		public void __add_variable_15__(){
			addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),"",new ExternalStatement(new StringEntry("_token"),""),new ExternalStatement(".",new ExternalStatement(new StringEntry("_root"),""))));
		}
		public void __add_method_0__(){
		...
		public void __add_method_18__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("get_result");}},Arrays.asList(new ExternalVariableEntry[]{}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("_result"),"")))));
		}
		public void __add_method_19__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new StringEntry("void")),"",new Entry(){public void get(StringBuilder builder){builder.append("set_result");}},Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("new_result");}},null)}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("_result = ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("new_result"),"")))));
		}
		public void __add_method_20__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Acceptor"),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("get_resultAcceptor");}},Arrays.asList(new ExternalVariableEntry[]{}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("_result_acceptor"),"")))));
		}
		public void __add_method_21__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new StringEntry("void")),"",new Entry(){public void get(StringBuilder builder){builder.append("set_resultAcceptor");}},Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""),new ExternalStatement(new StringEntry("Acceptor"),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("new_resultAcceptor");}},null)}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("_result_acceptor = ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("new_resultAcceptor"),"")))));
		}
	...
	public static class NameList extends ExternalClassEntry{
		...
		public void __add_variable_0__(){
			addVariable(new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Node"),""),new ExternalStatement(new StringEntry("Root"),""))),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("root"),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Node"),""),new ExternalStatement(new StringEntry("Root"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
		}
		public void __add_method_0__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Node"),""),new ExternalStatement(new StringEntry("Root"),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("getRoot");}},Arrays.asList(new ExternalVariableEntry[]{}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("root"),"")))));
		}
		public void __add_method_1__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new StringEntry("void")),"",new Entry(){public void get(StringBuilder builder){builder.append("setRoot");}},Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""),new ExternalStatement(new StringEntry("Node"),""),new ExternalStatement(new StringEntry("Root"),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("newRoot");}},null)}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("root = ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("newRoot"),"")))));
		}
		public void __add_method_2__(){
		...
		public void __add_method_6__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("removeAll"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""))),"",new ExternalStatement(new StringEntry("fromList"),""),null)}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("root"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("removeAll"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("fromList"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getRoot"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))))))))));
		}
		public void __add_method_7__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("addAll"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""))),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("fromList"),"")),null)}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("root"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("addAll"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("fromList"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getRoot"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))))))))));
		}
		public void __add_sub_class_0__(){
			addSubClass(Node._);
		}
		...
		public void __INIT__(){
			super.__SETUP__(
				new ExternalStatement("."),
			new Entry(){public void get(StringBuilder builder){}},
				new VariableNameEntry(("NameList").toString()),
				"class ",
				null,
				Arrays.asList(new Entry[]{}),
				null);
		...
		public static class Node extends ExternalClassEntry{
			...
			public void __INIT__(){
				super.__SETUP__(
					new ExternalStatement("."),
				new Entry(){public void get(StringBuilder builder){}},
					new VariableNameEntry(("Node").toString()),
					"class ",
					null,
					Arrays.asList(new Entry[]{}),
					null);
		...
		public static class Root extends ExternalClassEntry{
			...
			public void __INIT__(){
				...
				new Entry(){public void get(StringBuilder builder){}},
					new VariableNameEntry(("Root").toString()),
					"class ",
					new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""))),
					Arrays.asList(new Entry[]{}),
					null);
				setIsStatic(true);
				__add_method_0__();
		...
		public static class Child extends ExternalClassEntry{
			...
			public void __INIT__(){
				super.__SETUP__(
					new ExternalStatement("."),
				new Entry(){public void get(StringBuilder builder){}},
					new VariableNameEntry(("Child").toString()),
					"class ",
					new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("NameList"),""))),
					Arrays.asList(new Entry[]{}),
					null);
	...
	public static class Result extends ExternalClassEntry{
		...
		public void __add_method_14__(){
			addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),null,new ExternalStatement(new StringEntry("toString"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("state"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser.FAILED"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("lineNumber"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new StringEntry("getLineNumber"),"")),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),"",new ExternalStatement(new StringEntry("rangeIndex"),""),new ExternalStatement("-",new ExternalStatement(".",new ExternalStatement(new StringEntry("lineNumber"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1"),""))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("upperBound"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("lineNumberRanges"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("rangeIndex"),"")))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),"",new ExternalStatement(new StringEntry("lowerBound"),""),new ExternalStatement(".",new ExternalStatement(new StringEntry("0"),"")))),new ExternalStatement.Conditional("if",new ExternalStatement(">",new ExternalStatement(".",new ExternalStatement(new StringEntry("rangeIndex"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("0 "),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("lowerBound"),"")),new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("lineNumberRanges"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement("-",new ExternalStatement(".",new ExternalStatement(new StringEntry("rangeIndex"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1"),""))))))),new ExternalStatement(".",new ExternalStatement(new StringEntry("1"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(new StringEntry("errorAt"),""),null)),new ExternalStatement.Conditional("if",new ExternalStatement("<",new ExternalStatement(".",new ExternalStatement(new StringEntry("upperBound"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("input"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new StringEntry("length"),"")),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("errorAt"),"")),new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("input"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("substring"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("lowerBound"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")))))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"$>\""),""))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("input"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("substring"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("upperBound"),""))))))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("errorAt"),"")),new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("input"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("substring"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("lowerBound"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")))))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"<$\""),""))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("input"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("substring"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),""))))))))))),new ExternalStatement.Conditional("if",new ExternalStatement("<=",new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("0 "),""))),new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tError: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("errorAt"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tLine Number: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("lineNumber"),"")))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tError: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("errorAt"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tLine Number: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("lineNumber"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tFile Name: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("position"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("-1 "),""))),new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("<",new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1000 "),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"File Name: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\nParse Time: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"ms\""),""))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(null,null,"+",Arrays.asList(new String[]{"","+","+","+","/","+","+","%","+"}),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"File Name: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\nParse Time: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1000 "),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\".\""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1000 "),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"s\""),""))))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("<",new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1000 "),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tError: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("errorAt"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tLine Number: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("lineNumber"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tFile Name: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tParse Time: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"ms\""),""))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(null,null,"+",Arrays.asList(new String[]{"","+","+","+","+","+","+","+","/","+","+","%","+"}),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tError: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("errorAt"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tLine Number: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("lineNumber"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tFile Name: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\\tParse Time: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1000 "),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\".\""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1000 "),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"s\""),""))))))))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("0 "),""))),new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\""),"")))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"File Name: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("<",new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1000 "),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"File Name: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\nParse Time: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"ms\""),""))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(null,null,"+",Arrays.asList(new String[]{"","+","+","+","/","+","+","%","+"}),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"File Name: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\nParse Time: \""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1000 "),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\".\""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("parseTime"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("1000 "),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"s\""),""))))))))))))));
		}
		public void __add_sub_class_0__(){
			addSubClass(Pass._);
		}
		...
		public void __INIT__(){
			super.__SETUP__(
				new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new VariableNameEntry(MainFlow.self.packageName),"")),new ExternalStatement(new StringEntry("parser"),"")),
			new Entry(){public void get(StringBuilder builder){}},
				new VariableNameEntry(("Result").toString()),
				"class ",
				null,
				Arrays.asList(new Entry[]{}),
				null);
		...
		public static class Pass extends ExternalClassEntry{
			...
			public void __add_variable_0__(){
				addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),"",new ExternalStatement(new StringEntry("parsedRoot"),""),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))));
			}
			public void __add_variable_1__(){
				addVariable(new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Branch"),""))),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("root"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))));
			}
			public void __add_method_0__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("getParsedRoot");}},Arrays.asList(new ExternalVariableEntry[]{}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("parsedRoot"),"")))));
			}
			public void __add_method_1__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new StringEntry("void")),"",new Entry(){public void get(StringBuilder builder){builder.append("setParsedRoot");}},Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("newParsedRoot");}},null)}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("parsedRoot = ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("newParsedRoot"),"")))));
			}
			public void __add_method_2__(){
			...
			public void __add_method_3__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new StringEntry("void")),"",new Entry(){public void get(StringBuilder builder){builder.append("setRoot");}},Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Branch"),""))),"",new Entry(){public void get(StringBuilder builder){builder.append("newRoot");}},null)}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("root = ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("newRoot"),"")))));
			}
			public void __add_method_4__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("setup"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement("=",new ExternalStatement(".",new ExternalStatement(new StringEntry("root"),"")),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Branch"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new StringEntry("setup"),"")),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("root"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("parsedRoot"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("0"),"")))))))));
			}
			public void __add_method_5__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("setup"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Branch"),""))),"",new ExternalStatement(new StringEntry("current"),""),null),new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),""))),"",new ExternalStatement(new StringEntry("currentParsed"),""),null),new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),"",new ExternalStatement(new StringEntry("currentPosition"),""),null)}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("List"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Parsed"),"")))))),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("currentParsed"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getChildren"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("List"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),""))))),"",new ExternalStatement(new StringEntry("positions"),""),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("currentParsed"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getPositions"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),"",new ExternalStatement(new StringEntry("size"),""),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("currentParsed"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getChildren"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new StringEntry("size"),"")),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))),new ExternalStatement.Conditional("for",new ExternalStatement(";",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Integer"),"")),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),"")),new ExternalStatement(new StringEntry("0"),"")),new ExternalStatement("<",new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("size"),""))),new ExternalStatement(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),"")),new ExternalStatement(new StringEntry("++"),""))),new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("==",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),""))))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getChildren"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters())),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("isEmpty"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(new StringEntry("false"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Branch"),""))),"",new ExternalStatement(new StringEntry("newToken"),""),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Branch"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),""))))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getName"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("positions"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),"")))))),new ExternalStatement(".",new ExternalStatement(new StringEntry("currentPosition"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("this"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("current"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("newToken"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(".",new ExternalStatement(new StringEntry("setup"),"")),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("newToken"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),"")))))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("positions"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),"")))))))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("current"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParserToken"),""),new ExternalStatement(new StringEntry("Leaf"),""))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),""))))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getName"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("children"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),""))))),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("getValue"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("positions"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("get"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("i"),"")))))),new ExternalStatement(".",new ExternalStatement(new StringEntry("currentPosition"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("this"),"")))))))))))))))));
			}
			public void __add_method_6__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),null,new ExternalStatement(new StringEntry("toString"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement.Conditional("if",new ExternalStatement("!=",new ExternalStatement(".",new ExternalStatement(new StringEntry("fileName"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"Passed:\\n\\t\""),""))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("super"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("toString"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))))),new ExternalStatement.Conditional("else",null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))))))));
			}
			public void __INIT__(){
				super.__SETUP__(
					new ExternalStatement("."),
				new Entry(){public void get(StringBuilder builder){}},
					new VariableNameEntry(("Pass").toString()),
					"class ",
					new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Result"),"")),
					Arrays.asList(new Entry[]{}),
					null);
				setIsStatic(true);
				__add_variable_0__();
		...
		public static class Fail extends ExternalClassEntry{
			...
			public void __add_method_2__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),null,new ExternalStatement(new StringEntry("toString"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"Failed:\\n\\tRule:\""),""))),new ExternalStatement(".",new ExternalStatement(new StringEntry("ruleName"),"")),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("super"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("toString"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))))));
			}
			public void __INIT__(){
				super.__SETUP__(
					new ExternalStatement("."),
				new Entry(){public void get(StringBuilder builder){}},
					new VariableNameEntry(("Fail").toString()),
					"class ",
					new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("Result"),"")),
					Arrays.asList(new Entry[]{}),
					null);
		...
		public static class Acceptor extends ExternalClassEntry{
			...
			public void __add_variable_0__(){
				addVariable(new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("List"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),"")))))),"",new ExternalStatement(new StringEntry("results"),""),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("ArrayList"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),"")))))))),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))));
			}
			public void __add_method_0__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("List"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),"")))))),"",new Entry(){public void get(StringBuilder builder){builder.append("getResults");}},Arrays.asList(new ExternalVariableEntry[]{}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("results"),"")))));
			}
			public void __add_method_1__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new StringEntry("void")),"",new Entry(){public void get(StringBuilder builder){builder.append("setResults");}},Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(true,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("List"),""),new ExternalStatement(new StringEntry("<"),new StringEntry(">"),"",new ExternalStatement(",",new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),"")))))),"",new Entry(){public void get(StringBuilder builder){builder.append("newResults");}},null)}),"",new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("results = ")),new StringEntry(";"),"",new ExternalStatement(new StringEntry("newResults"),"")))));
			}
			public void __add_method_2__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("void"),"")),null,new ExternalStatement(new StringEntry("add"),""),Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),null)}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("setFileName"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("results"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("add"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),""))))))))));
			}
			public void __add_method_3__(){
				addMethod(new ExternalMethodEntry(0,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),null,new ExternalStatement(new StringEntry("toString"),""),Arrays.asList(new ExternalVariableEntry[]{}),null,new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("StringBuilder"),"")),"",new ExternalStatement(new StringEntry("builder"),""),new ExternalStatement.NewObject(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("StringBuilder"),"")))),new ExternalStatement.Parameters(new ExternalStatement.Parameters())))),new ExternalStatement.Conditional("for",new ExternalStatement(":",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),"",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),null),new ExternalStatement(".",new ExternalStatement(new StringEntry("results"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalVariableEntry(false,false,false,new ExternalStatement.TypeName(new ExternalStatement(new StringEntry("String"),"")),"",new ExternalStatement(new StringEntry("resultString"),""),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("result"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("toString"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))),new ExternalStatement.Conditional("if",new ExternalStatement("!=",new ExternalStatement(".",new ExternalStatement(new StringEntry("resultString"),"")),new ExternalStatement(".",new ExternalStatement(new StringEntry("null"),""))),new ExternalStatement.Body(new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("builder"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("append"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("\"\\n\""),"")))))))),new ExternalStatement(new TabEntry(new StringEntry("")),new StringEntry(";"),"",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("builder"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("append"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters(new ExternalStatement(".",new ExternalStatement(new StringEntry("resultString"),""))))))))))),new ExternalStatement(new TabEntry(new StringEntry("return ")),new StringEntry(";"),"",new ExternalStatement("+",new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("super"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("toString"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))),new ExternalStatement(".",new ExternalStatement(".",new ExternalStatement(new StringEntry("builder"),"")),new ExternalStatement(null,new StringEntry(")"),"(",new ExternalStatement(new StringEntry("toString"),""),new ExternalStatement.Parameters(new ExternalStatement.Parameters()))))))));
			}
			public void __INIT__(){
				super.__SETUP__(
					new ExternalStatement("."),
				new Entry(){public void get(StringBuilder builder){}},
					new VariableNameEntry(("Acceptor").toString()),
					"class ",
					new ExternalStatement.TypeName(new ExternalStatement(".",new ExternalStatement(new StringEntry("ExternalParser"),""),new ExternalStatement(new StringEntry("Result"),""))),
					Arrays.asList(new Entry[]{}),
					null);
				setIsStatic(true);
				__add_variable_0__();
