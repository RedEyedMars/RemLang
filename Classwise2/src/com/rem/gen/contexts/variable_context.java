...
public abstract class variable_context extends non_context{
	...
	public void parse_variable_assignment() {
		...
		if(_state==SUCCESS&&!_recursion_protection_name_var_43.contains(_position)) {
			_recursion_protection_name_var_43.add(_position);
			parse_name_var();
			_recursion_protection_name_var_43.remove(_position_name_var);
		}
		else {
			_state=FAILED;
		}
