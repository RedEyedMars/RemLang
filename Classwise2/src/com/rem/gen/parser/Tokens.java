...
public class Tokens{
	...
	public static class Syntax{
		...
		public static class syntax_1 extends Token.Parsed{
			...
			public static Token.Parsed instance = new Tokens.Syntax.syntax_1(Token.Id._instance);
			...
			public void setInstance(Token.Parsed newInstance) {
		...
		public static class syntax_2 extends Token.Parsed{
			...
			public static Token.Parsed comma = new Tokens.Syntax.syntax_2(Token.Id._comma);
			...
			public void setComma(Token.Parsed newComma) {
				comma = newComma;
			}
		}
		...
		public static class syntax_21 extends Token.Parsed{
			...
			public static Token.Parsed weak = new Tokens.Syntax.syntax_21(Token.Id._weak);
		...
		public static class syntax_31 extends Token.Parsed{
			...
			public static Token.Parsed conditional = new Tokens.Syntax.syntax_31(Token.Id._conditional);
		...
		public static class syntax_36 extends Token.Parsed{
			...
			public static Token.Parsed conditional = new Tokens.Syntax.syntax_36(Token.Id._conditional);
		...
		public static class syntax_37 extends Token.Parsed{
			...
			public static Token.Parsed isFinal = new Tokens.Syntax.syntax_37(Token.Id._isFinal);
			public static Token.Parsed NOT = new Tokens.Syntax.syntax_37(Token.Id._NOT);
			...
			public void setNOT(Token.Parsed newNOT) {
				NOT = newNOT;
			}
		}
		...
		public static class syntax_40 extends Token.Parsed{
			...
			public static Token.Parsed conditional = new Tokens.Syntax.syntax_40(Token.Id._conditional);
		...
		public static class syntax_41 extends Token.Parsed{
			...
			public static Token.Parsed PRINT = new Tokens.Syntax.syntax_41(Token.Id._PRINT);
		...
		public static class syntax_42 extends Token.Parsed{
			...
			public static Token.Parsed conditional = new Tokens.Syntax.syntax_42(Token.Id._conditional);
		...
		public static class syntax_47 extends Token.Parsed{
			...
			public static Token.Parsed NEW = new Tokens.Syntax.syntax_47(Token.Id._NEW);
		...
		public static class syntax_49 extends Token.Parsed{
			...
			public static Token.Parsed add = new Tokens.Syntax.syntax_49(Token.Id._add);
		...
		public static class syntax_50 extends Token.Parsed{
			...
			public static Token.Parsed get = new Tokens.Syntax.syntax_50(Token.Id._get);
		...
		public static class syntax_53 extends Token.Parsed{
			...
			public static Token.Parsed ARRAY_TYPE = new Tokens.Syntax.syntax_53(Token.Id._ARRAY_TYPE);
		...
		public static class syntax_56 extends Token.Parsed{
			...
			public static Token.Parsed INLINE_LIST = new Tokens.Syntax.syntax_56(Token.Id._INLINE_LIST);
		...
		public static class syntax_57 extends Token.Parsed{
			...
			public static Token.Parsed typeName = new Tokens.Syntax.syntax_57(Token.Id._typeName);
		...
		public static class syntax_58 extends Token.Parsed{
			...
			public static Token.Parsed OutputClass = new Tokens.Syntax.syntax_58(Token.Id._OutputClass);
		...
		public static class syntax_59 extends Token.Parsed{
			...
			public static Token.Parsed OutputMethod = new Tokens.Syntax.syntax_59(Token.Id._OutputMethod);
		...
		public static class syntax_60 extends Token.Parsed{
			...
			public static Token.Parsed OutputVariable = new Tokens.Syntax.syntax_60(Token.Id._OutputVariable);
		...
		public static class syntax_61 extends Token.Parsed{
			...
			public static Token.Parsed OutputContext = new Tokens.Syntax.syntax_61(Token.Id._OutputContext);
		...
		public static class syntax_66 extends Token.Parsed{
			...
			public static Token.Parsed OutputQuote = new Tokens.Syntax.syntax_66(Token.Id._OutputQuote);
		...
		public static class syntax_67 extends Token.Parsed{
			...
			public static Token.Parsed OutputCast = new Tokens.Syntax.syntax_67(Token.Id._OutputCast);
		...
		public static class syntax_68 extends Token.Parsed{
			...
			public static Token.Parsed OutputString = new Tokens.Syntax.syntax_68(Token.Id._OutputString);
		...
		public static class syntax_69 extends Token.Parsed{
			...
			public static Token.Parsed OutputStatement = new Tokens.Syntax.syntax_69(Token.Id._OutputStatement);
		...
		public static class syntax_75 extends Token.Parsed{
			...
			public static Token.Parsed Id = new Tokens.Syntax.syntax_75(Token.Id._Id);
		...
		public static class syntax_76 extends Token.Parsed{
			...
			public static Token.Parsed Parser = new Tokens.Syntax.syntax_76(Token.Id._Parser);
		...
		public static class syntax_79 extends Token.Parsed{
			...
			public static Token.Parsed OutputNewObject = new Tokens.Syntax.syntax_79(Token.Id._OutputNewObject);
		...
		public static class syntax_80 extends Token.Parsed{
			...
			public static Token.Parsed Result = new Tokens.Syntax.syntax_80(Token.Id._Result);
		...
		public static class syntax_81 extends Token.Parsed{
			...
			public static Token.Parsed Pass = new Tokens.Syntax.syntax_81(Token.Id._Pass);
		...
		public static class syntax_82 extends Token.Parsed{
			...
			public static Token.Parsed Fail = new Tokens.Syntax.syntax_82(Token.Id._Fail);
		...
		public static class syntax_83 extends Token.Parsed{
			...
			public static Token.Parsed OutputBody = new Tokens.Syntax.syntax_83(Token.Id._OutputBody);
		...
		public static class syntax_84 extends Token.Parsed{
			...
			public static Token.Parsed OutputType = new Tokens.Syntax.syntax_84(Token.Id._OutputType);
		...
		public static class syntax_85 extends Token.Parsed{
			...
			public static Token.Parsed OutputExact = new Tokens.Syntax.syntax_85(Token.Id._OutputExact);
		...
		public static class syntax_86 extends Token.Parsed{
			...
			public static Token.Parsed CallableOutput = new Tokens.Syntax.syntax_86(Token.Id._CallableOutput);
		...
		public static class syntax_87 extends Token.Parsed{
			...
			public static Token.Parsed OutputCall = new Tokens.Syntax.syntax_87(Token.Id._OutputCall);
		...
		public static class syntax_88 extends Token.Parsed{
			...
			public static Token.Parsed OutputHelper = new Tokens.Syntax.syntax_88(Token.Id._OutputHelper);
		...
		public static class syntax_89 extends Token.Parsed{
			...
			public static Token.Parsed OutputOperator = new Tokens.Syntax.syntax_89(Token.Id._OutputOperator);
		...
		public static class syntax_93 extends Token.Parsed{
			...
			public static Token.Parsed OutputLambda = new Tokens.Syntax.syntax_93(Token.Id._OutputLambda);
		...
		public static class syntax_94 extends Token.Parsed{
			...
			public static Token.Parsed OutputBraced = new Tokens.Syntax.syntax_94(Token.Id._OutputBraced);
		...
		public static class syntax_95 extends Token.Parsed{
			...
			public static Token.Parsed Output = new Tokens.Syntax.syntax_95(Token.Id._Output);
		...
		public static class syntax_96 extends Token.Parsed{
			...
			public static Token.Parsed LineableOutput = new Tokens.Syntax.syntax_96(Token.Id._LineableOutput);
		...
		public static class syntax_97 extends Token.Parsed{
			...
			public static Token.Parsed OutputNewObject = new Tokens.Syntax.syntax_97(Token.Id._OutputNewObject);
		...
		public static class syntax_98 extends Token.Parsed{
			...
			public static Token.Parsed OutputArguments = new Tokens.Syntax.syntax_98(Token.Id._OutputArguments);
		...
		public static class syntax_99 extends Token.Parsed{
			...
			public static Token.Parsed OutputBody = new Tokens.Syntax.syntax_99(Token.Id._OutputBody);
		...
		public static class syntax_100 extends Token.Parsed{
			...
			public static Token.Parsed OutputClass = new Tokens.Syntax.syntax_100(Token.Id._OutputClass);
		...
		public static class syntax_101 extends Token.Parsed{
			...
			public static Token.Parsed OutputExact = new Tokens.Syntax.syntax_101(Token.Id._OutputExact);
		...
		public static class syntax_102 extends Token.Parsed{
			...
			public static Token.Parsed OutputHelper = new Tokens.Syntax.syntax_102(Token.Id._OutputHelper);
		...
		public static class syntax_103 extends Token.Parsed{
			...
			public static Token.Parsed OutputMethod = new Tokens.Syntax.syntax_103(Token.Id._OutputMethod);
		...
		public static class syntax_104 extends Token.Parsed{
			...
			public static Token.Parsed OutputNewObject = new Tokens.Syntax.syntax_104(Token.Id._OutputNewObject);
		...
		public static class syntax_105 extends Token.Parsed{
			...
			public static Token.Parsed OutputOperator = new Tokens.Syntax.syntax_105(Token.Id._OutputOperator);
		...
		public static class syntax_106 extends Token.Parsed{
			...
			public static Token.Parsed OutputParameters = new Tokens.Syntax.syntax_106(Token.Id._OutputParameters);
		...
		public static class syntax_107 extends Token.Parsed{
			...
			public static Token.Parsed OutputStatement = new Tokens.Syntax.syntax_107(Token.Id._OutputStatement);
		...
		public static class syntax_109 extends Token.Parsed{
			...
			public static Token.Parsed OutputVariable = new Tokens.Syntax.syntax_109(Token.Id._OutputVariable);
		...
		public static class syntax_110 extends Token.Parsed{
			...
			public static Token.Parsed getAllSafely = new Tokens.Syntax.syntax_110(Token.Id._getAllSafely);
		...
		public static class syntax_112 extends Token.Parsed{
			...
			public static Token.Parsed asVariable = new Tokens.Syntax.syntax_112(Token.Id._asVariable);
	...
	public static class Name{
		...
		public static class ConditionalOperatorToken extends Token.Parsed{
			protected String value = null;
			public ConditionalOperatorToken(final Token.Id initalSuperName, final String value) {
				super(initalSuperName);
				this.value = value;
			}
			public ConditionalOperatorToken(final String value) {
				this.value = value;
			}
			...
			public Token.Id getName() {
				return Token.Id._conditional_operator;
			}
		}
		public static class ConditionalChoiceToken extends Token.Parsed{
			protected String value = null;
			public ConditionalChoiceToken(final Token.Id initalSuperName, final String value) {
				super(initalSuperName);
				this.value = value;
			}
			public ConditionalChoiceToken(final String value) {
				this.value = value;
			}
			public ConditionalChoiceToken() {
			}
			public String getValue() {
				if(children.isEmpty()) {
					return value;
			...
			public Token.Id getName() {
				return Token.Id._conditional_choice;
			}
		}
		...
		public static class InlineMethodReferenceToken extends Token.Parsed{
			protected String value = null;
			public InlineMethodReferenceToken(final Token.Id initalSuperName, final String value) {
				super(initalSuperName);
				this.value = value;
			}
			public InlineMethodReferenceToken(final String value) {
				this.value = value;
			}
			public InlineMethodReferenceToken() {
			}
			public String getValue() {
				if(children.isEmpty()) {
					return value;
			...
			public Token.Id getName() {
				return Token.Id._inline_method_reference;
			}
		}
		...
		public static class ThrowsExceptionToken extends Token.Parsed{
			protected String value = null;
			public ThrowsExceptionToken(final Token.Id initalSuperName, final String value) {
				super(initalSuperName);
				this.value = value;
			}
			public ThrowsExceptionToken(final String value) {
				this.value = value;
			}
			public ThrowsExceptionToken() {
			}
			public String getValue() {
				if(children.isEmpty()) {
					return value;
			...
			public Token.Id getName() {
				return Token.Id._throwsException;
			}
		}
		...
		public static class NameAtomToken extends Token.Parsed{
			protected String value = null;
			public NameAtomToken(final Token.Id initalSuperName, final String value) {
				super(initalSuperName);
				this.value = value;
			}
			public NameAtomToken(final String value) {
				this.value = value;
			}
	...
	public static class Rule{
		...
		public static class InheritanceDeclarationToken extends Token.Parsed{
			protected String value = null;
			public InheritanceDeclarationToken(final Token.Id initalSuperName) {
				super(initalSuperName);
			}
			public InheritanceDeclarationToken() {
			}
			public String getValue() {
				if(value==null) {
					return super.getValue();
			...
			public Token.Id getName() {
				return Token.Id._inheritance_declaration;
			}
		}
		...
		public static class MethodPrototypeParametersToken extends Token.Parsed{
			protected String value = null;
			public MethodPrototypeParametersToken(final Token.Id initalSuperName) {
				super(initalSuperName);
			}
			public MethodPrototypeParametersToken() {
			}
			public String getValue() {
				if(value==null) {
					return super.getValue();
			...
			public Token.Id getName() {
				return Token.Id._method_prototype_parameters;
			}
		}
