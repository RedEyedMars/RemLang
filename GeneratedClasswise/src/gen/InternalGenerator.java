...
public class InternalGenerator extends Generator {
	...
	public static final Element camelizeElement = new Element("camelize",new String[]{"Generator.camelize(",/*In*/".toString())"});
	...
	public static final Element bodyNewObjElement = new Element("bodyNewObj",new String[]{"new ",/*Method Name*/"(",/*Parameters*/")"});
	...
	public static final Element declareVariableWithAssignmentFinalElement = new Element("declareVariableWithAssignmentFinal",new String[]{"final ",/*Type*/" ",/*Name*/" = ",/*Assignment*/""});
	public static final Element declareVariableWithAssignmentNonFinalElement = new Element("declareVariableWithAssignmentNonFinal",new String[]{"",/*Type*/" ",/*Name*/" = ",/*Assignment*/""});
	public static final Element declareVariableWithoutAssignmentNonFinalElement = new Element("declareVariableWithoutAssignmentNonFinal",new String[]{"",/*Type*/" ",/*Name*/""});
	public static final Element declareVariableWithoutAssignmentFinalElement = new Element("declareVariableWithoutAssignmentFinal",new String[]{"final ",/*Type*/" ",/*Name*/""});
	public static final Element declareStaticVariableWithAssignmentFinalElement = new Element("declareStaticVariableWithAssignmentFinal",new String[]{"static final ",/*Type*/" ",/*Name*/" = ",/*Assignment*/""});
	public static final Element declareStaticVariableWithAssignmentNonFinalElement = new Element("declareStaticVariableWithAssignmentNonFinal",new String[]{"static ",/*Type*/" ",/*Name*/" = ",/*Assignment*/""});
	public static final Element declareStaticVariableWithoutAssignmentNonFinalElement = new Element("declareStaticVariableWithoutAssignmentNonFinal",new String[]{"static ",/*Type*/" ",/*Name*/""});
	public static final Element declareStaticVariableWithoutAssignmentFinalElement = new Element("declareStaticVariableWithoutAssignmentFinal",new String[]{"static final ",/*Type*/" ",/*Name*/""});
	...
	public static final Element declareMethodElement = new Element("declareMethod",new String[]{"public ",/*IsStatic*/"",/*Type*/" ",/*Name*/"(",/*Parameters*/") {",/*Method Body*/""});
