...
public class EEntryEntry implements Entry,IInnerable,IImportable {
	public EEntryEntry getSelf(){
		return this;
	}
	...
	public EEntryEntry(Entry iValue){
		value = iValue;
		isInner = true;
	}
	...
	public void get(StringBuilder builder){
		if((value != null)){
			new ElementEntry(ExternalGenerator.bodyEntryElement,new ListEntry(value)).get(builder);
		}
	}
}