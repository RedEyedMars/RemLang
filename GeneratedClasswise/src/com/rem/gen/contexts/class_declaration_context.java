...
import java.util.*;
import java.io.*;
import com.rem.gen.contexts.class_variable_name_definition_context;
import com.rem.gen.parser.Token;
import com.rem.gen.parser.Parser;
import com.rem.gen.parser.Tokens;

public abstract class class_declaration_context extends class_variable_name_definition_context{
	...
	public void parse_class_declaration() {
		...
		if(_state==SUCCESS&&!_recursion_protection_inner_8.contains(_position)) {
			_recursion_protection_inner_8.add(_position);
			parse_inner();
			_recursion_protection_inner_8.remove(_position_inner);
		}
		else {
			_state=FAILED;
		}
