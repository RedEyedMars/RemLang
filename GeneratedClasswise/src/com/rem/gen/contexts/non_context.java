...
public abstract class non_context extends import_context{
	...
	public void parse_non_class_name() {
		...
		if(_state==SUCCESS) {
			_token.add(_position,Tokens.Syntax.syntax_57.OutputClass);
		...
		if(_state==FAILED) {
			...
			if(_state==SUCCESS) {
				_token.add(_position,Tokens.Syntax.syntax_58.OutputMethod);
			...
			if(_state==FAILED) {
				...
				if(_state==SUCCESS) {
					_token.add(_position,Tokens.Syntax.syntax_59.OutputVariable);
				...
				if(_state==FAILED) {
					...
					if(_state==SUCCESS) {
						_token.add(_position,Tokens.Syntax.syntax_60.OutputContext);
					...
					if(_state==FAILED) {
						...
						if(_state==FAILED) {
							...
							if(_state==FAILED) {
								...
								if(_state==SUCCESS) {
									_token.add(_position,Tokens.Syntax.syntax_65.OutputQuote);
									_position=_position+5;
									while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
										++_position;
									}
								...
								if(_state==FAILED) {
									...
									if(_state==SUCCESS) {
										_token.add(_position,Tokens.Syntax.syntax_66.OutputCast);
									...
									if(_state==FAILED) {
										...
										if(_state==SUCCESS) {
											_token.add(_position,Tokens.Syntax.syntax_67.OutputString);
											_position=_position+6;
											while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
												++_position;
											}
										...
										if(_state==FAILED) {
											...
											if(_state==SUCCESS) {
												_token.add(_position,Tokens.Syntax.syntax_68.OutputStatement);
												...
												if(_state==FAILED) {
													...
													if(_state==FAILED) {
														...
														if(_state==FAILED) {
															...
															if(_state==SUCCESS) {
																_token.add(_position,Tokens.Syntax.syntax_74.Id);
															...
															if(_state==FAILED) {
																...
																if(_state==SUCCESS) {
																	_token.add(_position,Tokens.Syntax.syntax_75.Parser);
																	_position=_position+6;
																	while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																		++_position;
																	}
																...
																if(_state==FAILED) {
																	...
																	if(_state==FAILED) {
																		...
																		if(_state==SUCCESS) {
																			_token.add(_position,Tokens.Syntax.syntax_78.OutputNewObject);
																		...
																		if(_state==FAILED) {
																			...
																			if(_state==SUCCESS) {
																				_token.add(_position,Tokens.Syntax.syntax_79.Result);
																				_position=_position+6;
																				while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																					++_position;
																				}
																			...
																			if(_state==FAILED) {
																				...
																				if(_state==SUCCESS) {
																					_token.add(_position,Tokens.Syntax.syntax_80.Pass);
																					_position=_position+4;
																					while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																						++_position;
																					}
																				...
																				if(_state==FAILED) {
																					...
																					if(_state==SUCCESS) {
																						_token.add(_position,Tokens.Syntax.syntax_81.Fail);
																						_position=_position+4;
																						while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																							++_position;
																						}
																					...
																					if(_state==FAILED) {
																						...
																						if(_state==SUCCESS) {
																							_token.add(_position,Tokens.Syntax.syntax_82.OutputBody);
																							_position=_position+4;
																							while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																								++_position;
																							}
																						...
																						if(_state==FAILED) {
																							...
																							if(_state==SUCCESS) {
																								_token.add(_position,Tokens.Syntax.syntax_83.OutputType);
																								_position=_position+4;
																								while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																									++_position;
																								}
																							...
																							if(_state==FAILED) {
																								...
																								if(_state==SUCCESS) {
																									_token.add(_position,Tokens.Syntax.syntax_84.OutputExact);
																									_position=_position+5;
																									while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																										++_position;
																									}
																								...
																								if(_state==FAILED) {
																									...
																									if(_state==SUCCESS) {
																										_token.add(_position,Tokens.Syntax.syntax_85.CallableOutput);
																										_position=_position+8;
																										while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																											++_position;
																										}
																									...
																									if(_state==FAILED) {
																										...
																										if(_state==SUCCESS) {
																											_token.add(_position,Tokens.Syntax.syntax_86.OutputCall);
																											_position=_position+4;
																											while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																												++_position;
																											}
																										...
																										if(_state==FAILED) {
																											...
																											if(_state==SUCCESS) {
																												_token.add(_position,Tokens.Syntax.syntax_87.OutputHelper);
																												_position=_position+6;
																												while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																													++_position;
																												}
																											...
																											if(_state==FAILED) {
																												...
																												if(_state==SUCCESS) {
																													_token.add(_position,Tokens.Syntax.syntax_88.OutputOperator);
																													_position=_position+8;
																													while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																														++_position;
																													}
																												...
																												if(_state==FAILED) {
																													...
																													if(_state==FAILED) {
																														...
																														if(_state==SUCCESS) {
																															_token.add(_position,Tokens.Syntax.syntax_92.OutputLambda);
																															_position=_position+6;
																															while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																++_position;
																															}
																														...
																														if(_state==FAILED) {
																															...
																															if(_state==SUCCESS) {
																																_token.add(_position,Tokens.Syntax.syntax_93.OutputBraced);
																																_position=_position+6;
																																while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																	++_position;
																																}
																															...
																															if(_state==FAILED) {
																																...
																																if(_state==SUCCESS) {
																																	_token.add(_position,Tokens.Syntax.syntax_94.Output);
																																	_position=_position+6;
																																	while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																		++_position;
																																	}
																																...
																																if(_state==FAILED) {
																																	...
																																	if(_state==SUCCESS) {
																																		_token.add(_position,Tokens.Syntax.syntax_95.LineableOutput);
																																		_position=_position+8;
																																		while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																			++_position;
																																		}
																																	...
																																	if(_state==FAILED) {
																																		...
																																		if(_state==SUCCESS) {
																																			_token.add(_position,Tokens.Syntax.syntax_96.OutputNewObject);
																																		...
																																		if(_state==FAILED) {
																																			...
																																			if(_state==SUCCESS) {
																																				_token.add(_position,Tokens.Syntax.syntax_97.OutputArguments);
																																			...
																																			if(_state==FAILED) {
																																				...
																																				if(_state==SUCCESS) {
																																					_token.add(_position,Tokens.Syntax.syntax_98.OutputBody);
																																					_position=_position+1;
																																					while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																						++_position;
																																					}
																																				...
																																				if(_state==FAILED) {
																																					...
																																					if(_state==SUCCESS) {
																																						_token.add(_position,Tokens.Syntax.syntax_99.OutputClass);
																																						_position=_position+1;
																																						while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																							++_position;
																																						}
																																					...
																																					if(_state==FAILED) {
																																						...
																																						if(_state==SUCCESS) {
																																							_token.add(_position,Tokens.Syntax.syntax_100.OutputExact);
																																							_position=_position+1;
																																							while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																								++_position;
																																							}
																																						...
																																						if(_state==FAILED) {
																																							...
																																							if(_state==SUCCESS) {
																																								_token.add(_position,Tokens.Syntax.syntax_101.OutputHelper);
																																								_position=_position+1;
																																								while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																									++_position;
																																								}
																																							...
																																							if(_state==FAILED) {
																																								...
																																								if(_state==SUCCESS) {
																																									_token.add(_position,Tokens.Syntax.syntax_102.OutputMethod);
																																									_position=_position+1;
																																									while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																										++_position;
																																									}
																																								...
																																								if(_state==FAILED) {
																																									...
																																									if(_state==SUCCESS) {
																																										_token.add(_position,Tokens.Syntax.syntax_103.OutputNewObject);
																																										_position=_position+1;
																																										while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																											++_position;
																																										}
																																									...
																																									if(_state==FAILED) {
																																										...
																																										if(_state==SUCCESS) {
																																											_token.add(_position,Tokens.Syntax.syntax_104.OutputOperator);
																																											_position=_position+1;
																																											while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																												++_position;
																																											}
																																										...
																																										if(_state==FAILED) {
																																											...
																																											if(_state==SUCCESS) {
																																												_token.add(_position,Tokens.Syntax.syntax_105.OutputParameters);
																																												_position=_position+1;
																																												while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																													++_position;
																																												}
																																											...
																																											if(_state==FAILED) {
																																												...
																																												if(_state==SUCCESS) {
																																													_token.add(_position,Tokens.Syntax.syntax_106.OutputStatement);
																																													_position=_position+1;
																																													while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																														++_position;
																																													}
																																												...
																																												if(_state==FAILED) {
																																													...
																																													if(_state==FAILED) {
																																														...
																																														if(_state==SUCCESS) {
																																															_token.add(_position,Tokens.Syntax.syntax_108.OutputVariable);
																																															_position=_position+1;
																																															while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
																																																++_position;
																																															}
	...
	public void parse_non_class_variable_name_definition() {
		...
		if(_state==FAILED) {
			...
			if(_state==SUCCESS) {
				_token.add(_position,Tokens.Syntax.syntax_55.INLINE_LIST);
				_position=_position+3;
				while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
					++_position;
				}
			...
			if(_state==FAILED) {
				...
				while(_position<_inputLength) {
					...
					if(_state==SUCCESS) {
						_token.add(_position,Tokens.Syntax.syntax_52.ARRAY_TYPE);
						_position=_position+2;
						while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
							++_position;
						}
