...
public abstract class AnonymousContext extends Parser.Context{
	...
	public void parse__anonymous_80() {
		...
		if(_state==SUCCESS) {
			_token.add(_position,Tokens.Syntax.syntax_109.getAllSafely);
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"name_var(_anonymous_80)");
				_furthestPosition=_position;
			}
		...
		if(_state==FAILED) {
			...
			if(_state==SUCCESS) {
				_token.add(_position,Tokens.Syntax.syntax_49.get);
	...
	public void parse__anonymous_82() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"name_atom(_anonymous_82)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_81() {
		...
		if(_state==SUCCESS) {
			_token.add(_position,Tokens.Syntax.syntax_110.SYNTAX);
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"name_var(_anonymous_81)");
				_furthestPosition=_position;
			}
		...
		if(_state==SUCCESS) {
			...
			_token__anonymous_81.setValue(_token.getValue());
		}
	...
	public void parse__anonymous_84() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"type_atom(_anonymous_84)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_77() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"non_class_name(_anonymous_77)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_76() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"non_class_name(_anonymous_76)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_79() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"name_var(_anonymous_79)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_78() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"name_var(_anonymous_78)");
				_furthestPosition=_position;
			}
			...
			boolean _iteration_achieved_76 = false;
			while(_position<_inputLength) {
				...
				if(_state==FAILED) {
					...
					_iteration_achieved_76=true;
				}
			}
			if(_iteration_achieved_76==false) {
				_state=FAILED;
			}
			else if(_state_76==SUCCESS&&_state==FAILED) {
				_state=SUCCESS;
			}
			if(_state==FAILED) {
				if(_position>=_furthestPosition) {
	...
	public void parse__anonymous_71() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"non_class_name(_anonymous_71)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_70() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"non_class_name(_anonymous_70)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_73() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"non_class_name(_anonymous_73)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_72() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"non_class_name(_anonymous_72)");
				_furthestPosition=_position;
			}
		...
		if(_state==SUCCESS) {
			_token__anonymous_72.add(_position__anonymous_72,_token);
		}
	...
	public void parse__anonymous_75() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"non_class_name(_anonymous_75)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_74() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"non_class_name(_anonymous_74)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_66() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"variable_declaration(_anonymous_66)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_65() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"variable_declaration(_anonymous_65)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_68() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"non_class_variable_name_definition(_anonymous_68)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_67() {
		...
		if(_state==SUCCESS) {
			_token.add(_position,Tokens.Syntax.syntax_36.isFinal);
			_position=_position+1;
			while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
				++_position;
			}
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"variable_declaration(_anonymous_67)");
				_furthestPosition=_position;
			}
		...
		if(_state==FAILED) {
			...
			if(_state==SUCCESS) {
				_token.add(_position,Tokens.Syntax.syntax_24.weak);
				_position=_position+1;
				while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
					++_position;
				}
	...
	public void parse__anonymous_69() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"class_variable_name_definition(_anonymous_69)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_60() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"method_argument(_anonymous_60)");
				_furthestPosition=_position;
			}
		...
		if(_state==FAILED) {
			...
			if(_state==SUCCESS&&!_recursion_protection_method_body_31.contains(_position)) {
				_recursion_protection_method_body_31.add(_position);
				parse_method_body();
				_recursion_protection_method_body_31.remove(_position_method_body);
			}
			else {
				_state=FAILED;
			}
	...
	public void parse__anonymous_62() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"method_declaration(_anonymous_62)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_61() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"method_declaration(_anonymous_61)");
				_furthestPosition=_position;
			}
		...
		if(_state==SUCCESS) {
			_token__anonymous_61.add(_position__anonymous_61,_token);
		}
	...
	public void parse__anonymous_64() {
		...
		if(_state==SUCCESS) {
			_token.add(_position,Tokens.Syntax.syntax_53.weak);
			_position=_position+3;
			while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
				++_position;
			}
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"method_declaration(_anonymous_64)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_63() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"method_declaration(_anonymous_63)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_54() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_access_token(_anonymous_54)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_57() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"method_parameters(_anonymous_57)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_56() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"method_parameters(_anonymous_56)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_59() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"method_argument(_anonymous_59)");
				_furthestPosition=_position;
			}
		...
		if(_state==SUCCESS) {
			...
			_token__anonymous_59.setValue(_token.getValue());
		}
	...
	public void parse__anonymous_58() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"method_argument(_anonymous_58)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_51() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_add_to_class(_anonymous_51)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_50() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_add_to_class(_anonymous_50)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_53() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_access_token(_anonymous_53)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_52() {
		...
		if(_state==SUCCESS&&!_recursion_protection_name_atom_30.contains(_position)) {
			_recursion_protection_name_atom_30.add(_position);
			parse_name_atom();
			_recursion_protection_name_atom_30.remove(_position_name_atom);
		}
		else {
			_state=FAILED;
		}
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_access_token(_anonymous_52)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_44() {
		...
		if(_state==FAILED) {
			...
			if(_state==SUCCESS&&!_recursion_protection_name_var_24.contains(_position)) {
				_recursion_protection_name_var_24.add(_position);
				parse_name_var();
				_recursion_protection_name_var_24.remove(_position_name_var);
			}
			else {
				_state=FAILED;
			}
			...
			if(_state==FAILED) {
				...
				if(_state==FAILED) {
					...
					if(_state==FAILED) {
						...
						_token=new Tokens.Name.GroupToken();
						_position_NAME=_position;
						if(_state==SUCCESS&&!_recursion_protection_NAME_26.contains(_position)) {
							_recursion_protection_NAME_26.add(_position);
							parse_NAME();
							_recursion_protection_NAME_26.remove(_position_NAME);
						}
						else {
							_state=FAILED;
						}
	...
	public void parse__anonymous_43() {
		...
		_token=new Token.Parsed(Token.Id.ANON);
		_position_name_var=_position;
		if(_state==SUCCESS&&!_recursion_protection_name_var_21.contains(_position)) {
			_recursion_protection_name_var_21.add(_position);
			parse_name_var();
			_recursion_protection_name_var_21.remove(_position_name_var);
		}
		else {
			_state=FAILED;
		}
	...
	public void parse__anonymous_45() {
		...
		if(_state==SUCCESS) {
			_token.add(_position,Tokens.Syntax.syntax_45.NEW);
			_position=_position+4;
			while(_position<_inputLength&&(false||_inputArray[_position]==' '||_inputArray[_position]=='\t'||_inputArray[_position]=='\n'||_inputArray[_position]=='\r')) {
				++_position;
			}
		...
		if(_state==SUCCESS) {
			...
			_token__anonymous_45.setValue(_token.getValue());
		}
	...
	public void parse__anonymous_49() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_add_to_class(_anonymous_49)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_32() {
		...
		if(_state==SUCCESS) {
			_token__anonymous_32.add(_position__anonymous_32,_token);
		}
	...
	public void parse__anonymous_37() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_statement(_anonymous_37)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_36() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_statement(_anonymous_36)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_39() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_call(_anonymous_39)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_38() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_call(_anonymous_38)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_22() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_element(_anonymous_22)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_24() {
		...
		if(_state==FAILED) {
			if(_position>=_furthestPosition) {
				_result=new Parser.Result.Fail(FAILED,_position,_lineNumberRanges,_input,_fileName,"body_conditional(_anonymous_24)");
				_furthestPosition=_position;
			}
	...
	public void parse__anonymous_26() {
		...
		if(_state==SUCCESS) {
			...
			_token__anonymous_26.setValue(_token.getValue());
		}
	...
	public void parse__anonymous_25() {
		...
		if(_state==SUCCESS) {
			...
			_token__anonymous_25.setValue(_token.getValue());
		}
