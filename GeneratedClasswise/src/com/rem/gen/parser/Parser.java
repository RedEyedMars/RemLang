...
public class Parser implements com.rem.output.helpers.OutputHelper.Parser<Parser.Result,Parser.Result.Pass> {
	...
	public Parser.Result parse(String fileName) {
		...
		if(firstResult.getState()==com.rem.output.helpers.OutputHelper.Parser.State.SUCCESS) {
			System.out.println("First-Pass Successful");
			fileNames.clear();
			Parser.Result secondResult = parseFile(fileName,SECOND_PASS);
			if(secondResult.getState()==com.rem.output.helpers.OutputHelper.Parser.State.SUCCESS) {
	...
	public static abstract class Context{
		...
		protected Set<Integer> _recursion_protection_statement_as_string_7 = new HashSet<Integer>();
		...
		protected Set<Integer> _recursion_protection_name_var_21 = new HashSet<Integer>();
		protected Set<Integer> _recursion_protection_NAME_22 = new HashSet<Integer>();
		protected Set<Integer> _recursion_protection_as_statement_23 = new HashSet<Integer>();
		protected Set<Integer> _recursion_protection_name_var_24 = new HashSet<Integer>();
		protected Set<Integer> _recursion_protection_type_var_25 = new HashSet<Integer>();
		protected Set<Integer> _recursion_protection_NAME_26 = new HashSet<Integer>();
		...
		protected Set<Integer> _recursion_protection_name_atom_30 = new HashSet<Integer>();
		protected Set<Integer> _recursion_protection_method_body_31 = new HashSet<Integer>();
		protected Set<Integer> _recursion_protection_class_declaration_32 = new HashSet<Integer>();
		protected Set<Integer> _recursion_protection_method_declaration_33 = new HashSet<Integer>();
		...
		protected Set<Integer> _recursion_protection_inner_37 = new HashSet<Integer>();
		protected Set<Integer> _recursion_protection_name_var_38 = new HashSet<Integer>();
		...
		public Set<Integer> get_recursionProtectionStatementAsString7() {
			return _recursion_protection_statement_as_string_7;
		}
		public void set_recursionProtectionStatementAsString7(Set<Integer> new_recursionProtectionStatementAsString7) {
			_recursion_protection_statement_as_string_7 = new_recursionProtectionStatementAsString7;
		}
		...
		public Set<Integer> get_recursionProtectionNameVar21() {
			return _recursion_protection_name_var_21;
		}
		public void set_recursionProtectionNameVar21(Set<Integer> new_recursionProtectionNameVar21) {
			_recursion_protection_name_var_21 = new_recursionProtectionNameVar21;
		}
		...
		public Set<Integer> get_recursionProtectionAsStatement23() {
			return _recursion_protection_as_statement_23;
		}
		public void set_recursionProtectionAsStatement23(Set<Integer> new_recursionProtectionAsStatement23) {
			_recursion_protection_as_statement_23 = new_recursionProtectionAsStatement23;
		}
		public Set<Integer> get_recursionProtectionNameVar24() {
			return _recursion_protection_name_var_24;
		}
		public void set_recursionProtectionNameVar24(Set<Integer> new_recursionProtectionNameVar24) {
			_recursion_protection_name_var_24 = new_recursionProtectionNameVar24;
		}
		...
		public Set<Integer> get_recursionProtectionNAME26() {
			return _recursion_protection_NAME_26;
		}
		public void set_recursionProtectionNAME26(Set<Integer> new_recursionProtectionNAME26) {
			_recursion_protection_NAME_26 = new_recursionProtectionNAME26;
		}
		...
		public Set<Integer> get_recursionProtectionNameAtom30() {
			return _recursion_protection_name_atom_30;
		}
		public void set_recursionProtectionNameAtom30(Set<Integer> new_recursionProtectionNameAtom30) {
			_recursion_protection_name_atom_30 = new_recursionProtectionNameAtom30;
		}
		public Set<Integer> get_recursionProtectionMethodBody31() {
			return _recursion_protection_method_body_31;
		}
		public void set_recursionProtectionMethodBody31(Set<Integer> new_recursionProtectionMethodBody31) {
			_recursion_protection_method_body_31 = new_recursionProtectionMethodBody31;
		}
		public Set<Integer> get_recursionProtectionClassDeclaration32() {
			return _recursion_protection_class_declaration_32;
		}
		public void set_recursionProtectionClassDeclaration32(Set<Integer> new_recursionProtectionClassDeclaration32) {
			_recursion_protection_class_declaration_32 = new_recursionProtectionClassDeclaration32;
		}
		public Set<Integer> get_recursionProtectionMethodDeclaration33() {
			return _recursion_protection_method_declaration_33;
		}
		public void set_recursionProtectionMethodDeclaration33(Set<Integer> new_recursionProtectionMethodDeclaration33) {
			_recursion_protection_method_declaration_33 = new_recursionProtectionMethodDeclaration33;
		}
		...
		public Set<Integer> get_recursionProtectionInner37() {
			return _recursion_protection_inner_37;
		}
		public void set_recursionProtectionInner37(Set<Integer> new_recursionProtectionInner37) {
			_recursion_protection_inner_37 = new_recursionProtectionInner37;
		}
		public Set<Integer> get_recursionProtectionNameVar38() {
			return _recursion_protection_name_var_38;
		}
		public void set_recursionProtectionNameVar38(Set<Integer> new_recursionProtectionNameVar38) {
			_recursion_protection_name_var_38 = new_recursionProtectionNameVar38;
		}
	...
	public static class Result implements com.rem.output.helpers.OutputHelper.Parser.Result {
		...
		public com.rem.output.helpers.OutputHelper.Parser.State getState() {
			return state==Parser.SUCCESS?com.rem.output.helpers.OutputHelper.Parser.State.SUCCESS:com.rem.output.helpers.OutputHelper.Parser.State.FAIL;
		}
				...
				for(Integer i = 0;i<size;i++) {
					if(children.get(i).getChildren().isEmpty()==false) {
						...
						current.add(new Token.Leaf(children.get(i).getName(),children.get(i).getValue(),positions.get(i),currentPosition,this));
							...
							current.add(new Token.Leaf(Token.Id._import_imports,children.get(i).getValue(),positions.get(i),currentPosition,this));
						}
					}
				}
			}
